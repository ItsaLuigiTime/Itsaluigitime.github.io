...
-- Started on 2025-02-28 16:22:16
...
--
-- TOC entry 4701 (class 2604 OID 16400)
...
2	LAB7 POSTGRES	SET UP A DATABASE AND INSERT RECORDS AS DESCRIBED IN THE INSTRUCTIONS.	2025-02-28	1
\.


--
-- TOC entry 4853 (class 0 OID 16390)
-- Dependencies: 218
-- Data for Name: students; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.students (student_id, first_name, last_name, email, enrollment_date) FROM stdin;
1	Levi	Shenk	ldshenk@my.waketech.edu	\N
\.
...
--
-- TOC entry 4703 (class 2606 OID 16395)
...
-- Completed on 2025-02-28 16:22:17
